<probabilities>
    <probs
        id="probs_count">
        <heading>
            C. TABLE CONTAINS THE PROBABILITY AS THE RATIO: (NUMBER OF TIMES SUCCESSOR WORD APPEARS AFTER TARGET) / (NUMBER OF TIMES SUCCESSOR WORD APPEARS OVERALL)
        </heading>
        <table
            ...
            <tr>
                ...
                <th
                    style="border: 1px solid #dddddd; text-align: center; padding: 8px; background-color: #dddddd">Probability</th>
            </tr>
            {
